...
libraryDependencies ++= Seq(
  "com.anymindgroup" %% "zio-gcp-auth" % "0.1.5",
  // add clients based on needs
  "com.anymindgroup" %% "zio-gcp-storage" % "0.1.5", // includes zio-gcp-storage-v1 and zio-gcp-iamcredentials-v1
  // generated clients
  "com.anymindgroup" %% "zio-gcp-aiplatform-v1" % "0.1.5",
  "com.anymindgroup" %% "zio-gcp-pubsub-v1" % "0.1.5",
  "com.anymindgroup" %% "zio-gcp-storage-v1" % "0.1.5",
  "com.anymindgroup" %% "zio-gcp-iamcredentials-v1" % "0.1.5",
)
```

In a cross-platform project via [sbt-crossproject](https://github.com/portable-scala/sbt-crossproject) use `%%%` operator:
```scala
libraryDependencies += "com.anymindgroup" %%% "zio-gcp-auth" % "0.1.5"
// etc.
```
...
//> using scala 3.6.4
//> using dep com.anymindgroup::zio-gcp-auth::0.1.5
//> using dep com.anymindgroup::zio-gcp-storage::0.1.5
